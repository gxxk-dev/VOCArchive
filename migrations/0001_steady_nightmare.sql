...
INSERT INTO `__new_work_title`("uuid", "work_uuid", "is_official", "language", "title") SELECT "uuid", "work_uuid", "is_official", "language", "title" FROM `work_title`;--> statement-breakpoint
